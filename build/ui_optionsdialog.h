...
public:
    ...
    QLabel *label_2;
    QSpinBox *anonymizeDingoDollars;
    QWidget *tabNetwork;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeDingoDollars = new QSpinBox(tabMain);
        anonymizeDingoDollars->setObjectName(QStringLiteral("anonymizeDingoDollars"));
        anonymizeDingoDollars->setMinimum(2);
        anonymizeDingoDollars->setMaximum(10000);
        anonymizeDingoDollars->setSingleStep(10);
        anonymizeDingoDollars->setValue(1000);

        gridLayout->addWidget(anonymizeDingoDollars, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start DingoDollars after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start DingoDollars on system login", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of DingoDollars to keep anonymized", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", 0));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the DingoDollars client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the DingoDollars network through a SOCKS5 proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting DingoDollars.", 0));
#endif // QT_NO_TOOLTIP
