...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DINGO"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DINGO"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DINGO"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DINGO"));
