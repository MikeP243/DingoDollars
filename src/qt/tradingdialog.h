...
private slots:
    ...
    QString BuyDINGO(QString OrderType, double Quantity, double Rate);
    QString SellDINGO(QString OrderType, double Quantity, double Rate);
