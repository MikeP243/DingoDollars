...
const string strMessageMagic = "DingoDollars Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
	...
	nSubsidy = 252000 * COIN; // Pre-mine
	}
	else if (nHeight > 1 && nHeight <= 120960) {
	nSubsidy = 25 * COIN; // 3 Months PoW
	}       
	else if (nHeight > 120960) {
	nSubsidy = 6.25 * COIN; // 25 Years PoW			
	}
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
	...
	if(pindexPrev->nHeight >= 2 && pindexPrev->nHeight < 10080){
      nSubsidy = 100 * COIN;
    } else if(pindexPrev->nHeight >= 10080 && pindexPrev->nHeight < 20160){
      nSubsidy = 75 * COIN;
    } else if(pindexPrev->nHeight >= 20160 && pindexPrev->nHeight < 30240){
      nSubsidy = 50 * COIN;
	} else if(pindexPrev->nHeight >= 30240 && pindexPrev->nHeight < 40320){
      nSubsidy = 25 * COIN;
    }
...
{
    RenameThread("DingoDollars-loadblk");
