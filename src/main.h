...
#define START_MASTERNODE_PAYMENTS_TESTNET 1540198048
#define START_MASTERNODE_PAYMENTS 1540198048

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (2499.99*COIN);

static const int64_t STATIC_POS_REWARD = 12.5 * COIN; //Constant reward of 12.5 DINGO
